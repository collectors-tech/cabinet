...
Current live-channel follow-up: #1773 (`docs/validation/agent-live-telegram-channel-checklist.md`). #1716 must remain open or explicitly blocked until that checklist is completed or superseded by an approved blocker/follow-up.
