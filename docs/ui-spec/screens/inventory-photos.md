...
3. User stages multiple photos before save.
4. User sets primary image and previews full screen.
...
3. Drag/drop area
4. Camera controls
5. Staged upload preview list
6. Photo list row actions
7. Fullscreen preview dialog
...
- [ ] Multi-photo upload supports at least 5 files in one action.
- [ ] Staged preview is shown before upload commit.
- [ ] Reorder action persists display order after reload.
...
- `INV-P-005` multi-upload + staged preview.
- `INV-P-006` reorder and persist photo order.
