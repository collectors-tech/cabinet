...
## Goal
- Offer operational observability and safe diagnostics export.

## Scope
- In scope: Activity logs, export logs, debug toggle, secret redaction discipline.
- Out of scope: Non-v1 enhancements unless explicitly listed in feature backlog.

## User Stories
- As a collector, I need logging and diagnostics to be reliable and easy to use.
...
- Endpoints/services: /api/logs/activity, /api/logs/export
- External providers: eBay/OpenAI/OS features as applicable.

## Data Model Touchpoints
- Tables/entities: activity_logs.
