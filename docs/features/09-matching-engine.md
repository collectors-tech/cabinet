...
## Goal
- Map scanner candidates to collection items with confidence states.

## Scope
- In scope: Matching execution and result listing states.
- Out of scope: Non-v1 enhancements unless explicitly listed in feature backlog.

## User Stories
- As a collector, I need matching engine to be reliable and easy to use.
...
- Endpoints/services: /api/matching/run, /api/matching/results
- External providers: eBay/OpenAI/OS features as applicable.

## Data Model Touchpoints
- Tables/entities: scanner_matches.
