...
## Goal
- Track desired items with target pricing and hit highlighting.

## Scope
- In scope: Wishlist entry CRUD and hit signaling.
- Out of scope: Non-v1 enhancements unless explicitly listed in feature backlog.

## User Stories
- As a collector, I need wishlist to be reliable and easy to use.
...
- Endpoints/services: /api/wishlist
- External providers: eBay/OpenAI/OS features as applicable.

## Data Model Touchpoints
- Tables/entities: wishlist_entries.
