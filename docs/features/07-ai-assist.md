...
## Goal
- Use OpenAI to suggest normalized metadata with explicit confirmation.

## Scope
- In scope: AI toggle/test/suggest from title/photo; no auto-create.
- Out of scope: Non-v1 enhancements unless explicitly listed in feature backlog.

## User Stories
- As a collector, I need ai assist to be reliable and easy to use.
...
- Endpoints/services: /api/ai/*
- External providers: eBay/OpenAI/OS features as applicable.

## Data Model Touchpoints
- Tables/entities: profile secrets for API keys, ai_failures logs.
