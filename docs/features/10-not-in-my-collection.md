# 10 Not In My Collection

## Feature
- Name: Not In My Collection
- ID: 10
- Status: draft

## Goal
- Surface unowned candidates and provide action workflow.

## Scope
- In scope: Filter and action flow for ignore/wishlist/track/create-item.
- Out of scope: Non-v1 enhancements unless explicitly listed in feature backlog.

## User Stories
- As a collector, I need not in my collection to be reliable and easy to use.
...
- Endpoints/services: /api/discovery/not-in-collection, /api/discovery/action
- External providers: eBay/OpenAI/OS features as applicable.

## Data Model Touchpoints
- Tables/entities: discovery_actions, ignored_candidates.
