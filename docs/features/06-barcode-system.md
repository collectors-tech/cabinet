...
## Goal
- Support barcode capture, lookup, and external lookup flow.

## Scope
- In scope: Attach barcodes to items, local lookup, external provider lookup.
- Out of scope: Non-v1 enhancements unless explicitly listed in feature backlog.

## User Stories
- As a collector, I need barcode system to be reliable and easy to use.
...
- Endpoints/services: /api/items/{itemID}/barcodes, /api/barcodes/{barcode}*
- External providers: eBay/OpenAI/OS features as applicable.

## Data Model Touchpoints
- Tables/entities: item_barcodes.
