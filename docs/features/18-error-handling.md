...
## Goal
- Provide actionable, recoverable errors across runtime and providers.

## Scope
- In scope: Failure logs, provider health, retries, crash recovery state.
- Out of scope: Non-v1 enhancements unless explicitly listed in feature backlog.

## User Stories
- As a collector, I need error handling to be reliable and easy to use.
...
- Endpoints/services: /api/scanner/failures, /api/runtime/recovery, AI/scanner failure surfaces
- External providers: eBay/OpenAI/OS features as applicable.

## Data Model Touchpoints
- Tables/entities: scanner_failures, ai_failures, app_state.
