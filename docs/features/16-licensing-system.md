...
## Goal
- Offline license validation and feature gating for free/pro tiers.

## Scope
- In scope: License import/status checks and feature gates.
- Out of scope: Non-v1 enhancements unless explicitly listed in feature backlog.

## User Stories
- As a collector, I need licensing system to be reliable and easy to use.
...
- Endpoints/services: /api/license/*
- External providers: eBay/OpenAI/OS features as applicable.

## Data Model Touchpoints
- Tables/entities: profile_licenses, verification keys.
