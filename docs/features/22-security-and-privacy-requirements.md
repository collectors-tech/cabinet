...
## Goal
- Protect secrets and local data with secure-by-default controls.

## Scope
- In scope: Secret storage, offline validation, WebAuthn logging safety, no plaintext secrets.
- Out of scope: Non-v1 enhancements unless explicitly listed in feature backlog.

## User Stories
- As a collector, I need security and privacy requirements to be reliable and easy to use.
...
- Endpoints/services: Auth/licensing/secret endpoints and logging.
- External providers: eBay/OpenAI/OS features as applicable.

## Data Model Touchpoints
- Tables/entities: profile_secrets handling, logs redaction policy.
