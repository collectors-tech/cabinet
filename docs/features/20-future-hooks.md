...
## Goal
- Keep extension seams for providers and dormant feature flags.

## Scope
- In scope: Additional AI/providers, share comparison, for-sale and offers flags disabled.
- Out of scope: Non-v1 enhancements unless explicitly listed in feature backlog.

## User Stories
- As a collector, I need future hooks to be reliable and easy to use.
...
- Endpoints/services: N/A (design-time hooks)
- External providers: eBay/OpenAI/OS features as applicable.

## Data Model Touchpoints
- Tables/entities: for_sale, structured_offers_json, provider interfaces.
