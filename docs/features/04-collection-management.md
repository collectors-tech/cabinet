...
## Goal
- Track canonical items and owned instances with collector metadata.

## Scope
- In scope: Canonical item CRUD baseline and item instances.
- Out of scope: Non-v1 enhancements unless explicitly listed in feature backlog.

## User Stories
- As a collector, I need collection management to be reliable and easy to use.
...
- Endpoints/services: /api/items, /api/items/{itemID}/instances
- External providers: eBay/OpenAI/OS features as applicable.

## Data Model Touchpoints
- Tables/entities: canonical_items, instances.
