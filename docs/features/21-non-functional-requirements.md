...
## Goal
- Define measurable performance/reliability bars for release quality.

## Scope
- In scope: Startup/search/scanner timing, crash-free target, backup restore validation.
- Out of scope: Non-v1 enhancements unless explicitly listed in feature backlog.

## User Stories
- As a collector, I need non-functional requirements to be reliable and easy to use.
...
- Endpoints/services: Cross-cutting
- External providers: eBay/OpenAI/OS features as applicable.

## Data Model Touchpoints
- Tables/entities: Benchmark and QA evidence artifacts.
