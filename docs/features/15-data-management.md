...
## Goal
- Reliable import/export and maintenance for local data.

## Scope
- In scope: JSON/CSV export/import, dry-run/apply, conflict handling, reindex/repair.
- Out of scope: Non-v1 enhancements unless explicitly listed in feature backlog.

## User Stories
- As a collector, I need data management to be reliable and easy to use.
...
- Endpoints/services: /api/data/*
- External providers: eBay/OpenAI/OS features as applicable.

## Data Model Touchpoints
- Tables/entities: Snapshot files and in-db import pathways.
