...
## Goal
- Store originals and derivatives for local item photos.

## Scope
- In scope: Upload/list/delete photos, set primary, rebuild thumbnails, preview/fullscreen.
- Out of scope: Non-v1 enhancements unless explicitly listed in feature backlog.

## User Stories
- As a collector, I need photo system to be reliable and easy to use.
...
- Endpoints/services: /api/items/{itemID}/photos*
- External providers: eBay/OpenAI/OS features as applicable.

## Data Model Touchpoints
- Tables/entities: item_photos, media filesystem.
