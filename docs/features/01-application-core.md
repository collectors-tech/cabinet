...
## Goal
- Deliver local desktop runtime with embedded UI, local storage, updates, and backup foundations.

## Scope
- In scope: Desktop shell, embedded UI hosting, local SQLite lifecycle, media/backups, packaging and updates.
- Out of scope: Non-v1 enhancements unless explicitly listed in feature backlog.

## User Stories
- As a collector, I need application core to be reliable and easy to use.
...
- Endpoints/services: /healthz, /api/runtime, /api/runtime/recovery, backup and data export/import endpoints.
- External providers: eBay/OpenAI/OS features as applicable.

## Data Model Touchpoints
- Tables/entities: app_state, sqlite lifecycle, backup artifacts, media directory.
