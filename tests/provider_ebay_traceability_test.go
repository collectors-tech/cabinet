...
func TestEbayProviderTraceabilityImplemented(t *testing.T) {
	...
	requiredByID := map[string][]string{
		"INTEGRATION-005": {
			...
			"unsafe keyword/exclusion Unicode whitespace/format/control-text omission",
			...
			"unsafe saved-query region/condition filter omission including raw Unicode whitespace",
			"local emitted-candidate page-size cap",
			"trimmed Browse price value",
			"currentBidPrice fallback",
			"unsafe primary Browse price currentBidPrice fallback",
			"unsafe or malformed-percent Browse price amount skip",
			...
			"unsafe raw/encoded Browse price currency skip including raw Unicode whitespace",
			...
			"malformed-escape Browse listing id/title skip",
			"oversized Browse listing id/title skip",
			"invalid duplicate Browse listing id fallthrough",
			"case-insensitive comparison",
			"duplicate Browse item URL suppression",
			"lowercasing scheme/host, stripping default HTTP/HTTPS ports, stripping fragments",
			"invalid duplicate Browse item URL fallthrough",
			...
			"raw Unicode whitespace bearer-token guard",
			...
			"TestProviderSearchOmitsRawUnicodeWhitespaceQueryTextBeforeBrowseRequest",
			...
			"impossible Browse timestamp pair drop",
			...
			"TestProviderSearchDropsImpossibleBrowseTimestampPairs",
			"TestProviderSearchTrimsBrowsePriceValue",
			"TestProviderSearchUsesCurrentBidPriceWhenBrowsePriceMissing",
			"TestProviderSearchFallsBackToCurrentBidPriceWhenBrowsePriceUnsafe",
			...
			"TestProviderSearchSkipsBrowseTextFieldsWithMalformedEscapes",
			...
			"TestProviderSearchSkipsDuplicateBrowseItemURLs",
			"TestProviderSearchCanonicalizesBrowseItemAndImageURLs",
			"default HTTP/HTTPS port-stripped",
			"TestProviderSearchUsesFirstValidDuplicateBrowseItemURL",
			...
			"TestProviderSearchSkipsBrowseItemURLsWithEdgeUnicodeWhitespace",
			...
			"TestProviderSearchDropsBrowseImageURLsWithEdgeUnicodeWhitespace",
		...
		"INTEGRATION-007": {
			...
			"before trimming",
			"raw Unicode whitespace availability status text",
			...
			"TestProviderSearchIgnoresRawUnicodeWhitespaceAvailabilityStatusText",
			...
			"TestProviderSearchPreservesUnknownPositiveAvailabilityCount",
			"TestOpenAPIDocumentsEbaySavedSearchHandoffContract",
