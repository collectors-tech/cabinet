...
func TestEbayProviderTraceabilityImplemented(t *testing.T) {
	...
	requiredByID := map[string][]string{
		"INTEGRATION-005": {
			...
			"non-web, userinfo-bearing, raw-whitespace, raw-control, or encoded-control Browse item URL skip",
			"non-web, userinfo-bearing, raw-whitespace, raw-control, or encoded-control Browse image URL drop",
