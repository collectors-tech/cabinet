...
func TestEbayProviderTraceabilityImplemented(t *testing.T) {
	...
	requiredByID := map[string][]string{
		"INTEGRATION-005": {
			...
			"non-web, oversized, userinfo-bearing, raw-whitespace including Unicode whitespace, raw-control, or encoded-control Browse item URL skip",
			"non-web, oversized, userinfo-bearing, raw-whitespace including Unicode whitespace, raw-control, or encoded-control Browse image URL drop",
