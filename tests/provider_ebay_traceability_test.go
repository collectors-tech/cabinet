...
func TestEbayProviderTraceabilityImplemented(t *testing.T) {
	...
	requiredByID := map[string][]string{
		"INTEGRATION-005": {
			...
			"non-web, oversized, userinfo-bearing, malformed-escape, encoded-space, encoded Unicode whitespace/format, raw Unicode control/format, raw-whitespace including Unicode whitespace, raw-control, or encoded-control Browse item URL skip",
			"non-web, oversized, userinfo-bearing, malformed-escape, encoded-space, encoded Unicode whitespace/format, raw Unicode control/format, raw-whitespace including Unicode whitespace, raw-control, or encoded-control Browse image URL drop",
...
func TestEbayProviderSearchFailureTraceabilityImplemented(t *testing.T) {
	...
	requiredFragments := []string{
		...
		"invalid duplicate Browse listing id fallthrough",
		"case-insensitive comparison",
		"non-web, oversized, userinfo-bearing, encoded-space, encoded Unicode whitespace/format, raw Unicode control/format, raw-whitespace including Unicode whitespace, raw-control, or encoded-control Browse item URL skip",
		"non-web, oversized, userinfo-bearing, encoded-space, encoded Unicode whitespace/format, raw Unicode control/format, raw-whitespace including Unicode whitespace, raw-control, or encoded-control Browse image URL drop",
		"first-safe thumbnail/additional Browse image fallback",
		"blank Browse seller fallback",
		"raw-control, encoded-control, or Unicode format/control Browse seller fallback",
		"encoded-whitespace/control Browse seller fallback",
