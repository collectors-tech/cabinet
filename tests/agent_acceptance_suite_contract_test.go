...
func TestAgentAcceptanceSuiteEvidenceMapCoversIssue1716Scope(t *testing.T) {
	...
	requiredFragments := []string{
		...
		"Telegram production bot adapter Agent routing",
		...
		"TestCabinetRequestFromUpdateRoutesAgentTextCommand",
		"TestCabinetRequestFromUpdateRoutesAgentTextCallbackQuery",
		"TestDispatchUpdateToBotAPIReportsOutboundFailure",
