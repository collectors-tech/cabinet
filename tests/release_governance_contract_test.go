...
func TestTaskListNamesTheCurrentPrivateBetaCriticalPathTruthfully(t *testing.T) {
	...
	for _, fragment := range []string{
		...
		"#2064 [DONE]",
		"#2065 [DONE]",
		"#2057 [SOURCE MERGED / BLOCKED]",
		"#2048 [DONE]",
		"#2066 [DONE]",
		"The active Project 2 queue has no Ready cards",
		"repository settings were later applied",
		"verified compliant",
		"Owner/legal decisions and exact-candidate release-note/package verification remain open",
		"recorder source is available for #1869 but does not run or satisfy packaged acceptance by itself",
