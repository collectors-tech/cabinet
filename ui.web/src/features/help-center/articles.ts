...
export const helpCenterArticles: HelpCenterArticle[] = [
  {
    ...
    summary: 'Sign in, switch profiles, and confirm you are working in the right Cabinet data context.',
  ...
  },
  {
    ...
    title: 'Inventory',
    summary: 'Manage owned items, folder browsing, photos, barcodes, and AI assist workflows.',
    category: 'Sections',
  ...
  },
  {
    id: 'section-wishlist',
    title: 'Wishlist',
    summary: 'Track wanted items, priorities, and follow-up collection workflows.',
    category: 'Sections',
  ...
  },
  {
    ...
    title: 'Collections',
    summary: 'Organize grouped item sets and manage collection-scoped browsing context.',
    category: 'Sections',
  ...
  },
  {
    ...
    title: 'Integrations',
    summary: 'Connect providers, review diagnostics, and understand supported setup flows.',
    category: 'Sections',
  ...
  },
  {
    id: 'section-settings',
    title: 'Settings',
    summary: 'Adjust profile, appearance, notifications, and other Cabinet configuration surfaces.',
    category: 'Sections',
  ...
  },
  {
    id: 'section-chats',
    title: 'Chats',
    summary: 'Understand assistant/chat surfaces and where AI-guided workflows fit into Cabinet.',
    category: 'Sections',
    content: chatsGuide,
  },
  {
    ...
    summary: 'Learn shared Cabinet patterns like New, Create, filters, rows, and toasts.',
    category: 'Reference',
  ...
  },
  {
    ...
    summary: 'See how Help Center content is organized and how section guides are structured.',
    category: 'Reference',
