export function registerMarketWatchCases(firstCase: number, lastCase: number) {
  let caseNumber = 0
  const marketWatchIt = (title: string, test: () => void) => {
    caseNumber += 1
    if (caseNumber >= firstCase && caseNumber <= lastCase) {
      it(title, test)
    }
  }
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-004 shows deterministic workspace states', () => {
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-018 + #1540 presents saved integration search dashboard shell', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: {
        query_sets: [
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-022 places whole-page Create and Run actions in the global header without duplicate page title content', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: { query_sets: [] },
    }).as('querySets')
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-017 shows actionable provider health and persisted run history', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: {
        query_sets: [
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-017 renders provider health taxonomy states', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: { query_sets: [] },
    }).as('querySets')
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-004 shows load failure with retry recovery', () => {
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-001 creates provider-scoped query sets from selector controls', () => {
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-014 keeps scanner capture behind a secondary action', () => {
    cy.intercept('GET', '/api/scanner/query-sets', { statusCode: 200, body: { query_sets: [] } }).as(
      'querySets'
    )
    cy.intercept('GET', '/api/scanner/failures', { statusCode: 200, body: { failures: [] } }).as(
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-001 + #1542 manages saved-watch create edit cadence pause and delete lifecycle', () => {
    let querySets: Array<{
      id: string
      name: string
      keywords: string[]
  ...
  marketWatchIt('INTEGRATION-005 + #827 manages eBay saved-query create edit schedule and delete lifecycle', () => {
    let querySets: Array<{
      id: string
      name: string
      keywords: string[]
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-002 sends provider scope in run payload and shows provider-attributed results', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: {
        query_sets: [
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-002 runs eBay-only saved searches through the provider route', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: {
        query_sets: [
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-003 blocks create when provider scope is empty in multi-provider mode', () => {
    cy.intercept('GET', '/api/scanner/query-sets', { statusCode: 200, body: { query_sets: [] } }).as(
      'querySets'
    )
    cy.intercept('GET', '/api/scanner/failures', { statusCode: 200, body: { failures: [] } }).as(
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-003 surfaces run failure guidance and retry action', () => {
  ...
  marketWatchIt('INTEGRATION-005 + #827 distinguishes eBay provider search failures from credential denials', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: {
        query_sets: [
  ...
  marketWatchIt('INTEGRATION-005 + #827 surfaces eBay setup page-size validation diagnostics', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: {
        query_sets: [
    ...
    cy.get('[data-testid="scanner-action-feedback"]')
      ...
      .and('contain', 'Update the eBay setup page size before retrying.')
      .and('contain', 'Provider credentials are not the recovery step for this setup validation error.')
  ...
  marketWatchIt('INTEGRATION-005 + #827 surfaces eBay invalid query-set diagnostics', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: {
        query_sets: [
    ...
    cy.get('[data-testid="scanner-action-feedback"]')
      .should('contain', 'Run failed due to query validation.')
      .and('contain', 'Select an existing eBay saved query before retrying.')
      .and('contain', 'Refresh Market Watch if the query was deleted or changed elsewhere.')
      .and('contain', 'Provider credentials are not the recovery step for this saved-query validation error.')
      ...
      .and('not.contain', 'Review provider health and credentials before retrying.')
      .and('not.contain', 'Market Watch action was denied.')
      .and('not.contain', 'Sign in again')
  })

  marketWatchIt('INTEGRATION-005 + #827 surfaces eBay provider run method diagnostics', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: {
        query_sets: [
  ...
  marketWatchIt('INTEGRATION-005 + INTEGRATION-007 + #827 surfaces eBay provider run pagination metadata, observed-currency output, and stock state', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: {
        query_sets: [
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-016 + #1548 renders result inbox lifecycle filters and match provenance', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: {
        query_sets: [
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-016 + #1548 persists result dismissal through reload before downstream handoff', () => {
    let candidates = [
      {
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-006 runs Bonza AFX query and surfaces aggregated run summary', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: {
        query_sets: [
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-005 renders query table view with saved-query columns for rapid inspection', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: {
        query_sets: [
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-007 filters query table rows by provider status schedule attention and result state', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: {
        query_sets: [
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-005 refreshes table run history after scheduled refresh', () => {
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-005 + #1545 opens saved-watch details from table row activation and actions', () => {
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-009 persists output-detail Wishlist handoff provenance', () => {
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-010 persists output-detail Inventory handoff provenance', () => {
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-015 persists output-detail Purchase handoff provenance', () => {
    let purchaseOrders: Array<Record<string, unknown>> = []
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-012 hands output-detail context to Discoveries with saved-watch keyword', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: {
        query_sets: [
  ...
  marketWatchIt('INTEGRATION-005 + UI-SCREEN-MARKET-WATCH-009 + UI-SCREEN-MARKET-WATCH-010 preserves eBay output handoff response provenance', () => {
    let wishlistEntries: Array<Record<string, unknown>> = []
    let wishlistItems: Array<Record<string, unknown>> = []
    let inventoryItems: Array<Record<string, unknown>> = []
  ...
  marketWatchIt('UI-SCREEN-MARKET-WATCH-004 keeps no-output detail state explicit', () => {
    cy.intercept('GET', '/api/scanner/query-sets', {
      statusCode: 200,
      body: {
        query_sets: [
