describe('dashboard/ui-screen-discover', () => {
  ...
  it('UI-SCREEN-DISCOVER-004 keeps Discoveries as triage-only and excludes Market Watch query/run controls', () => {
    ...
    cy.get('[data-testid="discover-action-ignore-cand-003"]')
      .scrollIntoView()
      .should('be.visible')
    cy.get('[data-testid="discover-action-wishlist-cand-003"]')
      .scrollIntoView()
      .should('be.visible')
    cy.get('[data-testid="discover-action-track-cand-003"]')
      .scrollIntoView()
      .should('be.visible')
    cy.get('[data-testid="discover-action-create-cand-003"]')
      .scrollIntoView()
      .should('be.visible')
