...
func TestProviderSearchSkipsUnsafeBrowsePriceAmounts(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`{"itemSummaries":[{"itemId":"v1|raw-control-price|0","title":"Raw Control Price Slot Car","price":{"value":"\n12.50","currency":"AUD"},"itemWebUrl":"https://ebay/item/raw-control-price","seller":{"username":"seller-price"}},{"itemId":"v1|encoded-control-price|0","title":"Encoded Control Price Slot Car","price":{"value":"12.50%0A","currency":"AUD"},"itemWebUrl":"https://ebay/item/encoded-control-price","seller":{"username":"seller-price"}},{"itemId":"v1|malformed-escape-price|0","title":"Malformed Escape Price Slot Car","price":{"value":"12.50%ZZ","currency":"AUD"},"itemWebUrl":"https://ebay/item/malformed-escape-price","seller":{"username":"seller-price"}},{"itemId":"v1|trailing-percent-price|0","title":"Trailing Percent Price Slot Car","price":{"value":"12.50%","currency":"AUD"},"itemWebUrl":"https://ebay/item/trailing-percent-price","seller":{"username":"seller-price"}},{"itemId":"v1|unicode-format-price|0","title":"Unicode Format Price Slot Car","price":{"value":"1` + string(rune(0x202e)) + `2.50","currency":"AUD"},"itemWebUrl":"https://ebay/item/unicode-format-price","seller":{"username":"seller-price"}},{"itemId":"v1|encoded-unicode-price|0","title":"Encoded Unicode Price Slot Car","price":{"value":"%E2%80%AF12.50","currency":"AUD"},"itemWebUrl":"https://ebay/item/encoded-unicode-price","seller":{"username":"seller-price"}},{"itemId":"v1|safe-price|0","title":"Safe Price Slot Car","price":{"value":" 12.50 ","currency":"AUD"},"itemWebUrl":"https://ebay/item/safe-price","seller":{"username":"seller-price"}}]}`))
	}))
	defer srv.Close()
...
func TestProviderSearchSkipsUnsafeBrowsePriceCurrency(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`{"itemSummaries":[{"itemId":"v1|raw-control-currency|0","title":"Raw Control Currency Slot Car","price":{"value":"11.00","currency":"\nAUD"},"itemWebUrl":"https://ebay/item/raw-control-currency","seller":{"username":"seller-currency"}},{"itemId":"v1|encoded-control-currency|0","title":"Encoded Control Currency Slot Car","price":{"value":"12.00","currency":"AUD%0A"},"itemWebUrl":"https://ebay/item/encoded-control-currency","seller":{"username":"seller-currency"}},{"itemId":"v1|unicode-format-currency|0","title":"Unicode Format Currency Slot Car","price":{"value":"13.00","currency":"A` + string(rune(0x202e)) + `UD"},"itemWebUrl":"https://ebay/item/unicode-format-currency","seller":{"username":"seller-currency"}},{"itemId":"v1|unicode-whitespace-currency|0","title":"Unicode Whitespace Currency Slot Car","price":{"value":"13.25","currency":"` + string(rune(0x00a0)) + `AUD"},"itemWebUrl":"https://ebay/item/unicode-whitespace-currency","seller":{"username":"seller-currency"}},{"itemId":"v1|encoded-unicode-currency|0","title":"Encoded Unicode Currency Slot Car","price":{"value":"13.50","currency":"AUD%E2%80%AE"},"itemWebUrl":"https://ebay/item/encoded-unicode-currency","seller":{"username":"seller-currency"}},{"itemId":"v1|required-currency|0","title":"Required Currency Slot Car","price":{"value":"14.00","currency":" aud "},"itemWebUrl":"https://ebay/item/required-currency","seller":{"username":"seller-currency"}}]}`))
	}))
	defer srv.Close()
...
func TestProviderSearchSkipsDuplicateBrowseItemURLs(t *testing.T) {
	t.Parallel()

	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`{"itemSummaries":[{"itemId":"v1|url-duplicate-first|0","title":"First URL Duplicate Slot Car","price":{"value":"11.00","currency":"AUD"},"itemWebUrl":"https://www.ebay.com/itm/duplicate-url","seller":{"username":"seller-url"}},{"itemId":"v1|url-duplicate-second|0","title":"Second URL Duplicate Slot Car","price":{"value":"12.00","currency":"AUD"},"itemWebUrl":"HTTPS://WWW.EBAY.COM/ITM/DUPLICATE-URL","seller":{"username":"seller-url"}},{"itemId":"v1|url-unique|0","title":"Unique URL Slot Car","price":{"value":"13.00","currency":"AUD"},"itemWebUrl":"https://www.ebay.com/itm/unique-url","seller":{"username":"seller-url"}}]}`))
	}))
	defer srv.Close()
	...
	if len(items) != 2 {
		t.Fatalf("expected duplicate Browse item URL to be emitted once, got %+v", items)
	}
	if items[0].ListingID != "v1|url-duplicate-first|0" || items[0].URL != "https://www.ebay.com/itm/duplicate-url" {
		t.Fatalf("expected first normalized duplicate URL candidate to survive, got %+v", items[0])
	}
	if items[1].ListingID != "v1|url-unique|0" {
		t.Fatalf("expected unique URL candidate to survive after duplicate, got %+v", items[1])
	}
}

func TestProviderSearchUsesFirstValidDuplicateBrowseItemURL(t *testing.T) {
	t.Parallel()

	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`{"itemSummaries":[{"itemId":"v1|url-duplicate-invalid|0","title":"Invalid URL Duplicate Slot Car","price":{"value":"not-a-price","currency":"AUD"},"itemWebUrl":"https://www.ebay.com/itm/duplicate-url-fallthrough","seller":{"username":"seller-url"}},{"itemId":"v1|url-duplicate-valid|0","title":"Valid URL Duplicate Slot Car","price":{"value":"12.00","currency":"AUD"},"itemWebUrl":"https://www.ebay.com/itm/duplicate-url-fallthrough","seller":{"username":"seller-url"}},{"itemId":"v1|url-duplicate-later|0","title":"Later URL Duplicate Slot Car","price":{"value":"13.00","currency":"AUD"},"itemWebUrl":"https://www.ebay.com/itm/duplicate-url-fallthrough","seller":{"username":"seller-url"}}]}`))
	}))
	defer srv.Close()
	...
	if len(items) != 1 {
		t.Fatalf("expected first valid duplicate URL candidate to be emitted once, got %+v", items)
	}
	if items[0].ListingID != "v1|url-duplicate-valid|0" || items[0].Title != "Valid URL Duplicate Slot Car" {
		t.Fatalf("expected invalid duplicate URL to fall through to first valid candidate, got %+v", items[0])
	}
}

func TestProviderSearchCanonicalizesBrowseItemAndImageURLs(t *testing.T) {
	t.Parallel()
	...
	if len(items) != 2 {
		t.Fatalf("expected fragment-equivalent Browse item URLs to be emitted once, got %+v", items)
	}
...
func TestProviderSearchSkipsBrowseItemURLsWithNestedEncodedUnsafeText(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`{"itemSummaries":[{"itemId":"v1|nested-encoded-space-url|0","title":"Nested Encoded Space URL Slot Car","price":{"value":"11.00","currency":"AUD"},"itemWebUrl":"https://www.ebay.com/itm/nested%2520space","seller":{"username":"seller-url"}},{"itemId":"v1|deep-nested-encoded-space-url|0","title":"Deep Nested Encoded Space URL Slot Car","price":{"value":"11.50","currency":"AUD"},"itemWebUrl":"https://www.ebay.com/itm/deep%25252520space","seller":{"username":"seller-url"}},{"itemId":"v1|nested-encoded-format-url|0","title":"Nested Encoded Format URL Slot Car","price":{"value":"12.00","currency":"AUD"},"itemWebUrl":"https://www.ebay.com/itm/nested%25E2%2580%25AEformat","seller":{"username":"seller-url"}},{"itemId":"v1|valid-url|0","title":"Valid URL Slot Car","price":{"value":"13.00","currency":"AUD"},"itemWebUrl":"https://www.ebay.com/itm/valid-url","seller":{"username":"seller-url"}}]}`))
	}))
	defer srv.Close()
...
func TestProviderSearchSkipsUnsafeShippingCostAmounts(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`{"itemSummaries":[{"itemId":"v1|unsafe-shipping|0","title":"Unsafe Shipping Slot Car","price":{"value":"22.00","currency":"AUD"},"itemWebUrl":"https://ebay/item/unsafe-shipping","seller":{"username":"seller3"},"shippingOptions":[{"shippingCost":{"value":"\n7.25","currency":"AUD"}},{"shippingCost":{"value":"8.25%0A","currency":"AUD"}},{"shippingCost":{"value":"8.25%ZZ","currency":"AUD"}},{"shippingCost":{"value":"8.25%","currency":"AUD"}},{"shippingCost":{"value":"8` + string(rune(0x202e)) + `.75","currency":"AUD"}},{"shippingCost":{"value":"%E2%80%AF9.00","currency":"AUD"}},{"shippingCost":{"value":"9.50","currency":"AUD"}}]},{"itemId":"v1|unsafe-shipping-zero|0","title":"Unsafe Shipping Zero Slot Car","price":{"value":"23.00","currency":"AUD"},"itemWebUrl":"https://ebay/item/unsafe-shipping-zero","seller":{"username":"seller3"},"shippingOptions":[{"shippingCost":{"value":"4.25%0A","currency":"AUD"}},{"shippingCost":{"value":"4.25%ZZ","currency":"AUD"}},{"shippingCost":{"value":"4.25%","currency":"AUD"}},{"shippingCost":{"value":"5` + string(rune(0x202e)) + `.25","currency":"AUD"}}]}]}`))
	}))
	defer srv.Close()
...
func TestProviderSearchSkipsUnsafeShippingCurrency(t *testing.T) {
	...
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`{"itemSummaries":[{"itemId":"v1|shipping-currency-unsafe|0","title":"Unsafe Shipping Currency Slot Car","price":{"value":"22.00","currency":"AUD"},"itemWebUrl":"https://ebay/item/shipping-currency-unsafe","seller":{"username":"seller3"},"shippingOptions":[{"shippingCost":{"value":"6.25","currency":"` + string(rune(0x00a0)) + `AUD"}},{"shippingCost":{"value":"7.25","currency":"AUD%0A"}},{"shippingCost":{"value":"8.25","currency":"A` + string(rune(0x202e)) + `UD"}},{"shippingCost":{"value":"9.50","currency":"aud"}}]},{"itemId":"v1|shipping-currency-unsafe-zero|0","title":"Unsafe Shipping Currency Zero Slot Car","price":{"value":"23.00","currency":"AUD"},"itemWebUrl":"https://ebay/item/shipping-currency-unsafe-zero","seller":{"username":"seller3"},"shippingOptions":[{"shippingCost":{"value":"3.25","currency":"AUD` + string(rune(0x00a0)) + `"}},{"shippingCost":{"value":"4.25","currency":"AUD%0A"}},{"shippingCost":{"value":"5.25","currency":"A` + string(rune(0x202e)) + `UD"}}]}]}`))
	}))
	defer srv.Close()
...
func TestProviderSearchIgnoresRawUnicodeWhitespaceAvailabilityStatusText(t *testing.T) {
	t.Parallel()

	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.Header().Set("Content-Type", "application/json")
		_, _ = w.Write([]byte(`{"itemSummaries":[{"itemId":"v1|unicode-whitespace-stock|0","title":"Unicode Whitespace Stock Slot Car","price":{"value":"22.00","currency":"AUD"},"itemWebUrl":"https://ebay/item/unicode-whitespace-stock","seller":{"username":"seller-stock"},"estimatedAvailabilities":[{"estimatedAvailabilityStatus":"IN_STOCK` + string(rune(0x00a0)) + `","estimatedAvailableQuantity":8},{"estimatedAvailabilityStatus":"LIMITED` + string(rune(0x202f)) + `_STOCK","estimatedAvailableQuantity":4},{"estimatedAvailabilityStatus":"LIMITED_STOCK","estimatedAvailableQuantity":2}]}]}`))
	}))
	defer srv.Close()
	...
	if len(items) != 1 {
		t.Fatalf("expected raw-Unicode-whitespace availability status item to survive, got %+v", items)
	}
	if items[0].StockState != "low_stock" || items[0].StockCount != 2 {
		t.Fatalf("expected raw Unicode-whitespace availability statuses to be ignored before low_stock/2, got %+v", items[0])
	}
}
...
func TestProviderSearchCapsExcessiveRetryAfter(t *testing.T) {
	t.Parallel()
	...
	tests := []struct {
		...
		{name: "integer", retryAfter: "999999999"},
		{name: "http date", retryAfter: time.Now().UTC().Add(30 * 24 * time.Hour).Format(http.TimeFormat)},
	}
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			_, err := p.Search(context.Background(), scanner.QuerySet{Keywords: []string{"pokemon"}})
			if err == nil {
				t.Fatal("expected capped Retry-After Browse error")
			}
			var providerErr *ProviderError
			if !errors.As(err, &providerErr) {
				t.Fatalf("expected ProviderError, got %T %v", err, err)
			}
			if providerErr.RetryAfterSeconds != maxProviderRetryAfterSeconds {
				t.Fatalf("expected Retry-After cap %d, got %+v", maxProviderRetryAfterSeconds, providerErr)
			}
		})
	}
}
