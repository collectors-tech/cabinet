...
- **AND** Browse item summaries with non-HTTP(S) item URLs, oversized item URLs, URLs containing embedded userinfo, malformed percent-encoded escapes, embedded raw ASCII or Unicode whitespace, raw Unicode control/format characters, URLs containing percent-encoded ASCII spaces, URLs containing percent-encoded Unicode whitespace or format/control characters, or URLs containing raw or percent-encoded ASCII control bytes after trimming MUST be skipped instead of creating candidates with unsafe or non-clickable handoff provenance.
- **AND** optional Browse image URLs MUST be trimmed and preserved only when they are HTTP(S) URLs without embedded userinfo, malformed percent-encoded escapes, oversized length, embedded raw ASCII or Unicode whitespace, raw Unicode control/format characters, percent-encoded ASCII spaces, percent-encoded Unicode whitespace or format/control characters, or raw or percent-encoded ASCII control bytes; blank, relative, non-web, oversized, userinfo-bearing, malformed-escape, encoded-space, encoded-unsafe-Unicode, raw-unsafe-Unicode, raw-whitespace, or control-character image URLs MUST be dropped without rejecting an otherwise valid candidate.
