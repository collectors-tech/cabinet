...
- **AND** saved-query region and condition criteria containing raw ASCII control bytes, Unicode control or format characters, percent-encoded ASCII/Unicode whitespace/control/format characters, or nested percent-encoded unsafe text MUST be omitted before trimming or mapping so unsafe input cannot become a valid Browse filter.
