...
- **AND** normalized Browse price amounts MUST reject values containing raw or percent-encoded ASCII control bytes, malformed percent-escape sequences, Unicode control/format characters, raw non-ASCII whitespace, or percent-encoded ASCII/Unicode whitespace/control/format characters before trimming so unsafe upstream amount text cannot become a persisted scanner candidate price.
