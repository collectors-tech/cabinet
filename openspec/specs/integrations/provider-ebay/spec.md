...
- **AND** the adapter MUST trim and ignore keyword or exclusion criteria containing Unicode control or format characters before building the Browse request, and MUST reject a saved query that has no safe non-blank keyword criteria without calling eBay.
