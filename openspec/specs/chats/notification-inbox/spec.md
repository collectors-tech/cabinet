...
- **GIVEN** a user triggers an operational settings, storage maintenance, taxonomy settings, or Collections workspace action that renders inline or toast-backed success or failure status copy
