...
## Purpose
Define the governed entry points, safety boundaries, attachment handling, and external-channel intake rules for Cabinet Agent across in-app and approved channel surfaces.
