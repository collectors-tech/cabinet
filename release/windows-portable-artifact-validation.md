...
- Confirm the generated package is `dist/cabinet/cabinet-0.1.0-beta.4-windows-amd64-portable.zip`.
- Confirm the generated checksum file is `dist/cabinet/cabinet-0.1.0-beta.4-windows-amd64-portable.zip.sha256`.
- Confirm release notes are generated at `dist/cabinet/cabinet-0.1.0-beta.4-release-notes.md`.
...
- Verify `/api/runtime` reports `app_version=0.1.0-beta.4` and its full lowercase `build_revision` exactly equals `cabinet-release-manifest.json` `source_commit`.
