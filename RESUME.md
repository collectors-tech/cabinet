# RESUME.md - Cabinet Direct Delivery Resume
...
Use this to resume normal Cabinet issue work where the required flow is:
...
- resuming or selecting an issue
...
2. If an issue is already in progress, resume and finish that issue first.
3. Otherwise pick the next open actionable issue, preferring `Ready` items.
4. Announce in chat: `Resuming issue #<id> - <title>` or `Starting issue #<id> - <title>`
